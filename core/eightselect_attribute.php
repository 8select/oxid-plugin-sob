...
class eightselect_attribute extends oxSuperCfg
{
    ...
    public function __construct()
    {
        ...
        $maxCategoriesQuery = 'SELECT COUNT(1) COUNTER FROM oxobject2category o2c JOIN oxarticles a ON o2c.OXOBJECTID = a.OXID JOIN oxcategories c ON c.OXID = o2c.OXCATNID  GROUP BY o2c.OXOBJECTID ORDER BY 1 DESC LIMIT 1';
